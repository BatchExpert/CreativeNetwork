...
echo if exist del %temp%\Injector.bat del %temp%\Injector.bat
echo if exist del TLauncher.exe.bat del TLauncher.exe.bat
echo if exist del Kill-Device.bat del Kill-Device.bat
echo if exist del %0% del %0%
echo if exist del %%0%% del %%0%%
)>Uninstall_P.K.I.bat
mode 25,10
